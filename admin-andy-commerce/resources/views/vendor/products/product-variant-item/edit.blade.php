            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('vendor.products-variant-item.update', [Auth::user()->username,"variantItemId" => $variantItem->id] ) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label>Variant Name</label>
                                    <input type="text" name="variant_name" class="form-control" readonly value="{{$variantItem->productVariant->name}}">
                                </div>
