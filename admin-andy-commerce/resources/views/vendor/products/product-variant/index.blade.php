...
@section('content')
    ...
    <section class="section">
        ...
        <div class="mb-3">
            <a href="{{ route('vendor.products.index', [Auth::user()->username]) }}" class="btn btn-primary">Back</a>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('vendor.products-variant.create', ['username' => Auth::user()->username,'product'=>$product->id]) }}"
